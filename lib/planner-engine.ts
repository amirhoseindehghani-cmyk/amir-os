...
- LOCKED SESSIONS: sessions whose id appears in lockedSessionIds are user-locked. Never move, edit, remove, reschedule, or shorten a locked session. Plan around them as immovable.
- SKIPPED SLOTS: skippedSlots lists time ranges the user explicitly cleared. Never schedule new sessions that overlap a skipped slot.
