...
import type { Category, OngoingTask, PlanProposal, PlannerApiResponse, PlannerDocument, Priority, ProposalChange, Review, Session, WeekRecord, WeeklyTarget } from '@/lib/planner-types';
...
function DayView({ doc, setDoc, localToday, selectedDate, sessions, active, next, focusMinutes, fixedMinutes, onDate, onMorning, onReview, existingReview, onReplan, onToggle, onAdd, onReasoning, reasoning, onOpenWeek }: { doc: PlannerDocument; setDoc: Dispatch<SetStateAction<PlannerDocument>>; localToday: string; selectedDate: string; sessions: Session[]; active?: Session; next?: Session; focusMinutes: number; fixedMinutes: number; onDate: (date: string) => void; onMorning: () => void; onReview: () => void; existingReview?: Review; onReplan: () => void; onToggle: (session: Session) => void; onAdd: () => void; onReasoning: () => void; reasoning: boolean; onOpenWeek: () => void }) {
